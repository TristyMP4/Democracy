module.exports = {
    successMessages: [
        { message: "You shoplifted from the local CO-OP and sold the goods for **${amount}**!", signature: "#1 CO-OP Spender" },
        { message: "You committed tax fraud and saved **${amount}**.", signature: "Wait. That's Illegal!" },
        { message: "You grafted Tatra's Lubricant and sold it for **${amount}**.", signature: "that's the good stuff." },
        { message: "You held up the local monument and escaped with **${amount}** in scrap.", signature: "PP is OT" },
        { message: "You successfully raided the local clan and got out with **${amount}**!", signature: "were they loaded?" },
